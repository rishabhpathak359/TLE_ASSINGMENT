...
const Calendar: React.FC<Contests> = ({ contests }) => {
  ...
  return (
    <motion.div
      ...
      className="p-6 bg-white dark:bg-neutral-900 text-black dark:text-white rounded-xl shadow-xl transition-all"
    >
      <motion.div
      ...
      >
        <FullCalendar
          ...
          dayCellClassNames={() =>
            "p-4 transition-all rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800"
          }
          viewClassNames={() =>
